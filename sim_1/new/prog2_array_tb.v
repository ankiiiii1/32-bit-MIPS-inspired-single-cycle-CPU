`timescale 1ns / 1ps
// ================================================================
//  prog2_array_tb.v  - Full-system program test
//  Program: PROGRAM 2: Array sum [4,12,7,25,9]  (expect 57)
//
...
//
//  IMPORTANT: set instruction_memory to load "prog2_array.hex"
//             (change the $readmemh filename, or rename the hex to
//              machine_code.hex)
// ================================================================
module prog2_array_tb;
    reg clk, reset;
    ...
    initial begin
        $display("================================================");
        $display(" PROGRAM 2: Array sum [4,12,7,25,9]  (expect 57)");
        $display("================================================");
        reset = 1;
        @(posedge clk); #1;
        @(posedge clk); #1;
        ...
        chk_reg(3, 32'd57, "array total = 57");
        chk_mem(5, 32'd57, "MEM[20] = 57");
        $display("\n================================================");
