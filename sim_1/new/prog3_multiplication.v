`timescale 1ns / 1ps
// ================================================================
//  prog3_mult_tb.v  - Full-system program test
//  Program: PROGRAM 3: Multiply 6x7 via repeated addition (expect 42)
//
...
//
//  IMPORTANT: set instruction_memory to load "prog3_mult.hex"
//             (change the $readmemh filename, or rename the hex to
//              machine_code.hex)
// ================================================================
module prog3_mult_tb;
    reg clk, reset;
    ...
    initial begin
        $display("================================================");
        $display(" PROGRAM 3: Multiply 6x7 via repeated addition (expect 42)");
        $display("================================================");
        reset = 1;
        @(posedge clk); #1;
        @(posedge clk); #1;
        ...
        chk_reg(3, 32'd42, "6*7 = 42");
        chk_mem(0, 32'd42, "MEM[0] = 42");
        $display("\n================================================");
